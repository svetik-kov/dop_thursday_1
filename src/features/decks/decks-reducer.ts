...
type SetDeckErrorType = ReturnType<typeof setDeckErrorAC>
export const setDeckErrorAC = (error: string | null) => ({ type: 'DECK/DECK-ERROR', error } as const)